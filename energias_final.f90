...
INTEGER :: n,          &    !numero de timesteps
			  ...
			  i, j, k,    &    !contadores
			  proc_raiz,  &    !Número correspondente ao processo raiz (mestre)
	  		  ierr,       &    !Parâmetro do MPI
           myid,       &    !ID do processo em questão
           numprocs         !Número de processos 
...
!faz a primeira randomizacao e gera arquivo "new" com novos parametros
	...
	CALL novos_param(arqnew, pais, aux, pib(1), pib_eff, uso_pet(1), uso_ren(1), supdefnew, gasto_pc(1), &
            ...
            expo_tecnew, expo_gastonew, turn_pbnew, turn_petrennew, inc_barnew, inc_asstecnew, & 
				inc_tecbalnew, inc_tecrennew, seed, randpar, lim, crash, myid)
print*, 'huhu =', custo_pet(1)


DO i=1, numprocs-1

	CALL MPI_SEND(pib_util, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(gasto_pc, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(consumo, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(uso_pet, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(uso_ren, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(custo_bar, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(custo_barnew, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(custo_pet, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(custo_ren, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(custo_total, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(porc_util, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(porc_total, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(balanca, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(ed_cie_tec, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(ed_cie_tecnew, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(cond, 1, MPI_LOGICAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(arq, 15, MPI_CHARACTER, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(rend_bar, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(ass_social, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(consumo(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
  	CALL MPI_SEND(custo_pet(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(custo_pet(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(custo_ren(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(custo_total(1),  1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(pib_util(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(porc_total(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(porc_util(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(n, 1, MPI_INTEGER, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(j, 1, MPI_INTEGER, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(supdef, 2, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(custo_bar(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(prop_ren, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(custo_min, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(ed_cie_tec(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(expo_to, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(expo_tec, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(expo_gasto, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(turn_pb, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(turn_petren, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(inc_bar, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(inc_asstec, 5, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(inc_tecbal, 6, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(inc_tecren,5, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(arqnew, 15, MPI_CHARACTER, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(pais, 3, MPI_CHARACTER, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(aux, 3, MPI_CHARACTER, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(pib(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(pib_eff, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(uso_pet(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(uso_ren(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(supdefnew, 2, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(gasto_pc(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(custo_barnew(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(rend_bar, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(prop_rennew, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(custo_minnew,1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(ed_cie_tecnew(1), 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(ass_social, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(expo_tonew, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(expo_tecnew, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(expo_gastonew, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(turn_pbnew, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(turn_petrennew, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(inc_barnew, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(inc_asstecnew, 5, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(inc_tecbalnew, 6, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(inc_tecrennew, 5, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(seed, 1, MPI_INTEGER, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(randpar, 1, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(lim, 2, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(crash, 1, MPI_INTEGER, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(pop, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(pib, n, MPI_REAL, i, 0, MPI_COMM_WORLD, ierr)
	CALL MPI_SEND(numprocs, 1, MPI_INTEGER, i, 0, MPI_COMM_WORLD, ierr)

END DO

ELSE

	CALL MPI_RECV(pib_util, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(gasto_pc, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(consumo, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(uso_pet, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(uso_ren, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(custo_bar, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(custo_barnew, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(custo_pet, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(custo_ren, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(custo_total, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(porc_util, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(porc_total, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(balanca, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(ed_cie_tec, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(ed_cie_tecnew, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(cond, 1, MPI_LOGICAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(arq, 15, MPI_CHARACTER, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(rend_bar, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(ass_social, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(consumo(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
  	CALL MPI_RECV(custo_pet(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(custo_pet(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(custo_ren(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(custo_total(1),  1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(pib_util(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(porc_total(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(porc_util(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(n, 1, MPI_INTEGER, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(j, 1, MPI_INTEGER, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(supdef, 2, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(custo_bar(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(prop_ren, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(custo_min, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(ed_cie_tec(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(expo_to, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(expo_tec, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(expo_gasto, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(turn_pb, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(turn_petren, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(inc_bar, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(inc_asstec, 5, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(inc_tecbal, 6, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(inc_tecren,5, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(arqnew, 15, MPI_CHARACTER, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(pais, 3, MPI_CHARACTER, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(aux, 3, MPI_CHARACTER, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(pib(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(pib_eff, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(uso_pet(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(uso_ren(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(supdefnew, 2, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(gasto_pc(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(custo_barnew(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(rend_bar, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(prop_rennew, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(custo_minnew,1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(ed_cie_tecnew(1), 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(ass_social, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(expo_tonew, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(expo_tecnew, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(expo_gastonew, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(turn_pbnew, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(turn_petrennew, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(inc_barnew, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(inc_asstecnew, 5, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(inc_tecbalnew, 6, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(inc_tecrennew, 5, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(seed, 1, MPI_INTEGER, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(randpar, 1, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(lim, 2, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(crash, 1, MPI_INTEGER, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(pop, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(pib, n, MPI_REAL, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
	CALL MPI_RECV(numprocs, 1, MPI_INTEGER, proc_raiz, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)

!so' sai do loop qdo cond = TRUE
...
!so' sai do loop qdo cond = TRUE
		...
		!seed = seed + myid + oooo
		!oooo = oooo + 1
		!print*, "ooo", myid, " huhuu", seed
	!o j representa Low (1), Medium (2) e High (3) Variant
	DO j=1, 3
		
		!refazer o setup inicial
		...
		!loop de 2018 ate' 2100
		DO i=2,n

			!essas subrotinas so' precisam ser chamadas p/ uma Variant, pois nao se alteram para as demais
			IF (j == 1) THEN
		...
		!apenas uma otimizacao p/ so gerar o arquivo da High Variant quando cond é atingida
		IF (j == 1 .OR. j == 2) THEN
			CALL escreve_arq(pop, pib, gasto_pc, consumo, uso_pet, uso_ren, custo_barnew, custo_pet,  &
					custo_ren, custo_total, porc_util, porc_total, balanca, ed_cie_tecnew, pais, j, n, myid)
seed = seed + myid + oooo
		oooo = oooo + 1
		print*, "ooo", myid, " huhuu", seed
		END IF
		...
		IF (porc_total(crash-2017) <= lim(1) .AND. porc_total(crash-2017) >= lim(2) .AND. j == 3) THEN
			...
			DO i=1, numprocs-1
				CALL MPI_SEND(cond, 1, MPI_LOGICAL, i, 0, MPI_COMM_WORLD, ierr)
			END DO
			CALL MPI_RECV(cond, 1, MPI_LOGICAL, myid, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr)
			CALL escreve_arq(pop, pib, gasto_pc, consumo, uso_pet, uso_ren, custo_barnew, custo_pet,  &
					custo_ren, custo_total, porc_util, porc_total, balanca, ed_cie_tecnew, pais, j, n, myid)
		END IF
	...
	!caso cond nao foi atingida 
	IF (cond .EQV. .FALSE.) THEN
		
		!randomiza a partir da nova semente e gera o novo arquivo com os parametros	
		CALL randomize(supdef, custo_bar(1), prop_ren, custo_min, ed_cie_tec(1), expo_to, expo_tec, &
        	expo_gasto, turn_pb, turn_petren, inc_bar, inc_asstec, inc_tecbal, inc_tecren,   &
	     	custo_barnew(1), prop_rennew, custo_minnew, ed_cie_tecnew(1), expo_tonew, expo_tecnew, &
        		expo_gastonew, turn_pbnew, turn_petrennew, inc_barnew, supdefnew, inc_asstecnew, & 
...
SUBROUTINE setup(arq, pais, aux, pib, pib_eff, uso_pet, uso_ren, supdef, gasto_pc, &
	...
	OPEN (FILE = 'Usa_param.txt', UNIT = 1, STATUS = "old", ACTION = "read") !lendo arquivo c/ os parametros
		READ(1, *) tudo
		CLOSE(1)
...
SUBROUTINE novos_param(arqnew, pais, aux, pib, pib_eff, uso_pet, uso_ren, supdef, gasto_pc, &
            custo_bar, rend_bar, prop_ren, custo_min, ed_cie_tec, ass_social, expo_to, &
            expo_tec, expo_gasto, turn_pb, turn_petren, inc_bar, inc_asstec, inc_tecbal, inc_tecren, &
            seed, randpar, lim, crash, myid)

	IMPLICIT NONE
	CHARACTER(15), INTENT(inout) :: arqnew
	CHARACTER(3), INTENT(inout) :: pais,aux
	INTEGER, INTENT(inout) :: seed, crash, myid
	REAL*4, INTENT(inout) :: pib, pib_eff, uso_pet, uso_ren, gasto_pc, custo_bar, rend_bar, &
                         prop_ren, custo_min, ed_cie_tec, ass_social, expo_to, expo_tec, &
                         expo_gasto, turn_pb, turn_petren, inc_bar, randpar
   ...
   CHARACTER(2) :: id
	...
	OPEN (FILE = pais//"_new"//trim(id)//".txt", UNIT = 20, STATUS = "replace", ACTION = "write") !lendo arquivo c/ os parametros
...
SUBROUTINE economia (pop, pib_total, pib_eff, pib_util, pib_ant, gasto_ini, gasto_pc, consumo, custo_bar, & 
   ...
   REAL*4, DIMENSION(2), INTENT(inout) :: supdef
	...
	!calculos a seguir servem p/ todas Variants
	IF (j == 1) THEN
   	...
   	balanca = balanca + (random * (supdef(1)-supdef(2))) + supdef(2) !aleatorio entre sup e def
		...
		IF (pet >= barmin) THEN
			CALL flut_bar(random, flut) !gera a flutuacao no preco do barril de petroleo
...
SUBROUTINE escreve_arq (pop, pib, gasto_pc, consumo, uso_pet, uso_ren, custo_bar, custo_pet, custo_ren, &
					        custo_total, porc_util, porc_total, balanca, ed_cie_tec, pais, j, n, myid)

	IMPLICIT NONE
	INTEGER, INTENT (inout) :: n
	INTEGER, INTENT (in) :: j, myid
   ...
   ELSEIF (j == 2) THEN
	...
	OPEN (FILE = "Out_"//pais//aux//trim(id)//".txt", UNIT = 3, STATUS = "replace", ACTION = "write")
